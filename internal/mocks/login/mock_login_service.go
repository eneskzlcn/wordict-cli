...
// Source: github.com/eneskzlcn/dictionary-app-cli/internal/login (interfaces: LoginService)
...
func (m *MockLoginService) Login(arg0 login.SignInRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockLoginServiceMockRecorder) Login(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Login", reflect.TypeOf((*MockLoginService)(nil).Login), arg0)
}
